...
interface Props { t: Theme; uid: string; accounts: Account[]; onClose: () => void; onImported: () => void; onCreateAccount?: () => void }
...
export const ImportNickel = ({t,uid,accounts,onClose,onImported,onCreateAccount}: Props) => {
