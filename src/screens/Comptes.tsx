...
export const Comptes = ({ D, t, onEdit, onNew, onImport }: Props) => (
  <div style={{padding:'0 20px 16px'}}>
    ...
    {D.accounts.map(a=>{
      ...
      return (
        <button key={a.id} onClick={()=>onEdit(a)} style={{display:'flex',alignItems:'center',gap:14,padding:'16px',background:acc.alert?t.rD:t.card,border:'1px solid '+(acc.alert?t.rB:t.bo),borderRadius:16,marginBottom:10,cursor:'pointer',width:'100%',textAlign:'left'}}>
